...
class AnalyticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analytic" do
    assert_difference("Analytic.count") do
      post analytics_url, params: { analytic: { User_id: @analytic.User_id, data: @analytic.data } }
    end
  ...
  test "should update analytic" do
    patch analytic_url(@analytic), params: { analytic: { User_id: @analytic.User_id, data: @analytic.data } }
